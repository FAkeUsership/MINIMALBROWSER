...
Push a new matching version tag, for example `v1.2.3`. The workflow builds the bundled GeckoView ARM64 APK on GitHub, verifies package contents and checksum, and creates the matching release. Do not overwrite a prior version tag/release for a new version.
