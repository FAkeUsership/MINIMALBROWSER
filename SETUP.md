...
Push a new matching version tag, for example `v1.2.5`. The workflow builds a signed non-debuggable release variant of the bundled GeckoView ARM64 APK on GitHub, verifies package contents, signature, and checksum, and creates the matching release. Do not overwrite a prior version tag/release for a new version.
