...
- Mouse wheel input is routed once directly to the visible GeckoView with surface-local coordinates when Android sends it to the focused shell instead of the cursor target. This preserves vertical/horizontal scrolling inside web-app sidebars and nested lists as well as ordinary pages; mouse click, context-click, and Back/Forward side buttons retain their normal behavior.
